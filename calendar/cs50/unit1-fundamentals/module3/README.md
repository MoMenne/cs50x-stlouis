...
:--------:|:-----:|:--------------:|:--------------:|----------------
Class 1 | 2/11 |[Prep Work](./materials/class1-prep) <br> Read this: [How to Fix the Debugger](../../../helpful-resources) | [In Class](./materials/class1) | sorting algorithms, time complexity analysis, module1 review, more practice with functions
